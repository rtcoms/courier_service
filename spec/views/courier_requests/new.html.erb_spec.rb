...
RSpec.describe "courier_requests/new", type: :view do
  before(:each) do
    assign(:courier_request, CourierRequest.new(
      weight: 1,
      service_type: 1,
      cost: 1.5,
      payment_mode: 1,
  ...
  it "renders new courier_request form" do
    render

    assert_select "form[action=?][method=?]", courier_requests_path, "post" do
